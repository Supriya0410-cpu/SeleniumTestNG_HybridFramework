...
public class T5_OverviewTest extends BaseClass {
  ...
  public void setup() {
		...
		addwait();
		cp.docheckout();
		op= ch.ContinueCheckout(ExcelUtility.getStringData("userdata", 2, 1), ExcelUtility.getStringData("userdata", 3, 1), ExcelUtility.getAllTypeData("userdata", 4, 1));
		addwait();
